...
- **Pygame not found**: Install pygame via `pip install pygame>=2.5`
- **Config file not found**: Ensure `config/` directory exists with all YAML files
- **Logs directory**: Create `data/logs/` directory if it doesn't exist (should have `.gitkeep`)
